<div align= "center">
    <img src="https://capsule-render.vercel.app/api?type=soft&color=gradient&height=120&text=Hello!%20Welcome%20to%20Hyejee's%20github&animation=fadeIn&fontColor=000000&fontSize=70" />
    </div>
    <div style="text-align: left;"> 
    <h2 style="border-bottom: 1px solid #21262d; color: #c9d1d9;"> 안녕하세요. 풀스택 개발자 문혜지입니다. </h2>  
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #c9d1d9;"> 다양한 분야에 도전하는 것을 좋아하는 개발자입니다. </div> 
    </div>
    <div style="text-align: left;">
